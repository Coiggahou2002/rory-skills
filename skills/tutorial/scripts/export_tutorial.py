#!/usr/bin/env python3
"""Export one markdown tutorial to docx and html. PDF is generated via the Kami skill."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export a tutorial markdown file to docx and html.")
    ...
    parser.add_argument(
        ...
        choices=["docx", "html"],
        default=["docx", "html"],
        help="Which formats to generate. PDF is handled by the Kami skill separately.",
    )
...
def main() -> None:
    ...
    for fmt in args.formats:
        print(f"  - {fmt}")
    print("Note: PDF export is handled by the Kami skill separately.")
